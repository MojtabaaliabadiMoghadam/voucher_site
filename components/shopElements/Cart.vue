<template>
  <div class="fixed top-0 bottom-0 left-0 z-50 flex flex-col w-11/12 max-w-lg overflow-x-hidden bg-white shadow-lg">
...
import EmptyCart from "~/components/cartElements/EmptyCart.vue";
