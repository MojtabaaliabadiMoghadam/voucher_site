<template>
  <main>
    ...
    <div class="container flex flex-wrap items-center justify-center my-16 text-center gap-x-8 gap-y-4 brand lg:justify-between">
      <img src="@/assets/images/logoipsum-211.svg" alt="Brand 1" width="132" height="35" />
      <img src="@/assets/images/logoipsum-221.svg" alt="Brand 2" width="119" height="30" />
      <img src="@/assets/images/logoipsum-225.svg" alt="Brand 3" width="49" height="48" />
      <img src="@/assets/images/logoipsum-280.svg" alt="Brand 4" width="78" height="30" />
      <img src="@/assets/images/logoipsum-284.svg" alt="Brand 5" width="70" height="44" />
      <img src="@/assets/images/logoipsum-215.svg" alt="Brand 6" width="132" height="40" />
    </div>
    ...
    <section class="container grid gap-4 my-24 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="@/assets/icons/box.svg" width="60" height="60" alt="Free Shipping" loading="lazy" />
        <div>
      ...
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="@/assets/icons/moneyback.svg" width="60" height="60" alt="Money Back" loading="lazy" />
        <div>
      ...
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
                <img src="@/assets/icons/secure.svg" width="60" height="60" alt="Secure Payment" loading="lazy" />
        <div>
      ...
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
                <img src="@/assets/icons/support.svg" width="60" height="60" alt="Support 24/7" loading="lazy" />
        <div>
